...
contract AggregateLoanCoinToken is UnboundedRegularToken {

    uint public amount = 5*10**26;
    uint8 public decimals = 18;
    string public name = "AggregateLoanCoinToken";
    string public symbol = "ALOANC";
